...
// MVC 아키텍처에서 Model에 해당하는 클래스. DB의 POSTS 테이블의 내용.
// Model 클래스: (1) 필드, (2) 생성자, (3) getters    /setters는 잘 안만듦 , (4) toString()
public class Post {
    ...
    public static class PostBuilder{ // 클래스임 
        private Integer id;
