...
public class PostServiceImpl implements PostService {
    ...
    private PostDao postDao; // DB select, insert, update, delete 기능을 갖고 있음.
    ...
    public int create(PostCreateDto dto) {
        ...
        return postDao.insert(dto.toEntity()); // create는 service 메서드고 insert는 dao 메서드임! dto로 그냥 보내도 됨! 
    }
