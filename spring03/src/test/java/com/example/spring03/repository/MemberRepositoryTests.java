...
//    @Test
    @Transactional // roles 컬럼이 FetchType.LAZY로 설정되어 있기 때문. 안 넣으면 에러남!
    public void test3() {
        // Members 테이블 전체 검색
    ...
    public void test4() {
        ...
        try {
            Member m = memberRepository.findByUsername("TEST").get(); // 일치하는 사용자 정보는 없지만 try-catch로 묶었기 때문에 오류나지 않음.
